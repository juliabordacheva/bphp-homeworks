<?php
    class JsonFileAccessModel extends Config {
        ...
        public function __construct($fileName) {
            $this->fileName = $this->fileName = Config::DATABASE_PATH.$fileName.'.json';
        }
        ...
        public function write($text) {
            ...
            if(fwrite($this->file,$text)!== FALSE) echo 'Успешно';
            $this->disconnect();
        }
        ...
        public function writeJson($jsonObject){
            if(fopen($this->file,'w+') !== FALSE);
            if(fwrite($this->file,json_decode($jsonObject,JSON_PRETTY_PRINT))!== FALSE) echo 'Успешно';
            $this->disconnect();
        }
    }
